...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='finantrace'),
...
SITE_NAME = config('SITE_NAME', default='finanTrace')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='finanTrace <noreply@finantrace.app>')

GEMINI_API_KEY = config('GEMINI_API_KEY', default='')

PAYSTACK_SECRET_KEY = config('PAYSTACK_SECRET_KEY', default='')
PAYSTACK_PUBLIC_KEY = config('PAYSTACK_PUBLIC_KEY', default='')
PAYSTACK_STARTUP_PLAN_CODE = config('PAYSTACK_STARTUP_PLAN_CODE', default='')
PAYSTACK_GROWING_PLAN_CODE = config('PAYSTACK_GROWING_PLAN_CODE', default='')
